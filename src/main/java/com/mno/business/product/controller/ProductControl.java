...
public class ProductControl {
    ...
    private List<ProductDto> findProductOfShop(
        ...
        List<ProductDto> productDto =  productSer.changeListProDtoOfShop(productSer.findProduct(num, value,pageSize,desc), userInfo.getShop());
        productDto.forEach(
                productDto1 -> {
                    System.out.printf(productDto1.toString());
                }
        );
